...
Nf1 = 10;
af1= filter(y(N/2-Nf1/2:N/2+Nf1/2-1).*hamming(Nf1),1,d);
subplot(2,2,1)
plot(abs(fft(af1))), grid on , title("N =10")
Nf2 = 20;
af2= filter(y(N/2-Nf2/2:N/2+Nf2/2-1).*hamming(Nf2),1,d);
subplot(2,2,2)
plot(abs(fft(af2))), grid on , title("N =20")
Nf3 = 50;
af3= filter(y(N/2-Nf3/2:N/2+Nf3/2-1).*hamming(Nf3),1,d);
subplot(2,2,3)
plot(abs(fft(af3))), grid on , title("N =50")
Nf4 = 100;
af4= filter(y(N/2-Nf4/2:N/2+Nf4/2-1).*hamming(Nf1),1,d);
subplot(2,2,4)
